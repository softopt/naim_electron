...
function CheckOfflinePage() {
  ...
  return (
    <div className="msg-div">
      ...
      <p>
        This application needs to contact the online server to fetch new
        firmware. Please connect to the internet and try again.
      </p>
      <br />
      <button
...
export default CheckOfflinePage;
